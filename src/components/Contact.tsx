...
const Contact = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      icon: Phone,
      title: "Call Us",
      details: ["+91 92467 74777"],
      link: "tel:+919246774777",
    },
    {
      icon: Clock,
  ...
  return (
    <section id="contact" className="py-24 lg:py-32 bg-warm-gradient" ref={ref}>
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground">
            ...
            Our team is ready to help you find the perfect stone.
          </p>
        </motion.div>
        ...
        <div className="grid lg:grid-cols-5 gap-12">
          ...
          >
            <div className="glass rounded-3xl p-8 md:p-10 shadow-elevated border border-border/50">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    id="message"
                    placeholder="Tell us about your project - type of stone, quantity, location..."
                    rows={5}
                ...
                <Button
                  type="submit"
                  size="lg"
                  className="w-full h-14 text-base rounded-xl shadow-glow group"
          ...
          >
            {contactInfo.map((info, index) => (
              <motion.div
                ...
                className="flex gap-5 p-6 glass rounded-2xl border border-border/50 hover:border-primary/30 transition-all duration-300"
              >
                <div className="h-14 w-14 rounded-xl bg-gradient-to-br from-primary to-accent flex items-center justify-center flex-shrink-0 shadow-glow">
            ...
            <motion.a
              ...
              className="flex items-center gap-4 p-6 bg-green-500 hover:bg-green-600 rounded-2xl text-white transition-colors"
            >
            ...
            <motion.div
              ...
              className="rounded-2xl overflow-hidden border border-border h-48 shadow-soft"
            >
              <iframe
